...
const Home: React.FC = () => {
  const services = [
    {
      ...
      description:
        "Strategic social media management that builds communities and drives engagement across all platforms.",
    },
    {
      icon: Palette,
      title: "Brand Identity & Design",
      description:
        "Complete brand identity design that makes your business memorable and distinctive in the market.",
    },
    {
      icon: Search,
      title: "SEO Optimization",
      description:
        "Search engine optimization that gets your business found by the right customers at the right time.",
    },
    {
      icon: Mail,
      title: "Email Marketing",
      description:
        "Targeted email campaigns that nurture leads and convert them into loyal, paying customers.",
    },
    {
      icon: TrendingUp,
      title: "Performance Advertising",
      description:
        "Data-driven advertising campaigns that maximize ROI and drive measurable business results.",
    },
    {
      icon: Code,
      title: "Web & App Development",
      description:
        "Beautiful, functional websites and apps that provide exceptional user experiences and conversions.",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "AdGrades has been instrumental in boosting our digital reach. Their team truly understands the education sector. We've seen a sharp rise in engagement and visibility. Highly professional and results-driven service.",
      author: "Pranav Jha",
      role: "Owner, Medhavi Classes",
    },
    {
      quote:
        "We started with zero online presence. AdGrades built our brand identity from scratch. Now, our restaurant is recognized both online and offline. Couldn't have asked for a better marketing partner.",
      author: "Shreyas Bhadani",
      role: "Owner, Delhi 65 Restaurant",
    },
    {
      quote:
        "AdGrades helped shape our creative brand online. Their strategies brought in real clients and recognition. They captured our studio's essence beautifully. A dependable and creative team to work with.",
      author: "Abhishek",
      role: "Owner, Natraj Studios",
    },
    {
      quote:
        "AdGrades gave our brand a clear voice in the digital space. Their strategies were sharp, effective, and well-aligned with our goals. We saw real traction across platforms in a short time. Truly impressed with their expertise.",
      author: "Harsh Kumar",
      role: "Co-founder, OS Code",
    },
    {
      quote:
        "We went from being hidden to fully booked. AdGrades brought in real customers through smart ads. They told our story in a way people connected with. Thanks to them, every weekend is now packed.",
      author: "Suresh",
      role: "Owner, Dewdrop Homestays",
    },
    {
      quote:
        "We needed visibility in a niche market, and AdGrades delivered. Their campaigns showcased our laser cutting work with style. Leads, inquiries, and recognition have grown consistently. Smart, reliable, and creative team.",
      author: "Balakrishna",
    ...
    <div className="pt-16 overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          <div className="animate-fade-in">
            ...
            <h1 className="heading-primary text-foreground hero-title-glow mb-6 sm:mb-8 leading-tight">
              We Help <span className="brand-gradient-text">Startups</span>
              <br />
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-muted-foreground mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed px-4 description-text">
              Creative marketing, data-driven advertising, and stunning web
              design that transforms your vision into market-leading success
              stories.
            </p>

            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center px-4">
              <Link to="/contact" className="brand-button w-full sm:w-auto">
                Start a Project
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto px-4 description-text">
              Comprehensive marketing and design solutions that transform
      ...
      <section className="section-padding content-overlay">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8 sm:mb-12">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto px-4 description-text">
              We're proud to work with innovative businesses across various
              industries.
            </p>
          </div>
        </div>
      ...
      <section className="section-padding content-overlay">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="heading-secondary text-foreground mb-4 sm:mb-6">
              What Our <span className="brand-gradient-text">Clients Say</span>
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={testimonial.author} className="minimal-card p-6 sm:p-8">
      ...
      <section className="section-padding brand-gradient">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-white/90 mb-8 sm:mb-12 max-w-3xl mx-auto description-text">
            Let's discuss how we can transform your business into the next big
            success story.
          </p>
