              ...
              <div className={`grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center ${
                ...
                <div className={`${index % 2 === 1 ? 'lg:order-2' : 'lg:order-1'}`}>
                  <div className="flex items-center mb-6 sm:mb-8">
                    ...
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground text-glow">
                      {service.title}
                    </h2>
                  </div>
                  
                  <p className="text-base sm:text-lg text-muted-foreground text-glow mb-8 sm:mb-10 leading-relaxed">
                    {service.description}
                  </p>

                  {/* Process - Mobile Responsive */}
                  <div className="mb-8 sm:mb-10">
                    <h3 className="text-lg sm:text-xl font-semibold text-foreground text-glow mb-4 sm:mb-6">
                      Our 3-Step Process
                    </h3>
                    <div className="space-y-4 sm:space-y-6">
                      {service.process.map((step, stepIndex) => (
                        <div key={stepIndex} className="flex items-start">
                          ...
                          <div>
                            <h4 className="font-semibold text-foreground text-glow mb-1 sm:mb-2 text-sm sm:text-base">
                              {step.step}
                            </h4>
                  ...
                  <div className="minimal-card p-4 sm:p-6 mb-6 sm:mb-8 glass-effect aesthetic-glow">
                  ...
                  <Link
                    to="/contact"
                    className="brand-button inline-flex aesthetic-glow"
                  >
                    Let's Talk
                ...
                <div className={`${index % 2 === 1 ? 'lg:order-1' : 'lg:order-2'}`}>
                  <div className="relative group">
                    <div className={`w-full h-[300px] sm:h-[350px] lg:h-[400px] bg-gradient-to-br ${service.gradient} rounded-xl sm:rounded-2xl shadow-xl flex items-center justify-center transition-all duration-500 group-hover:shadow-2xl group-hover:scale-105 aesthetic-glow`}>
                      <service.icon className="h-16 w-16 sm:h-20 sm:w-20 lg:h-24 lg:w-24 text-white/30" />
                    </div>
                    <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 bg-card/90 backdrop-blur-xl p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-xl border border-border glass-effect">
                      <div className="text-xl sm:text-2xl font-bold text-foreground text-glow">
                        {index + 1}
                      </div>
